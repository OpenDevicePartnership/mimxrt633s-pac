#[doc = "Register `P0CFG` reader"]
pub type R = crate::R<P0cfgSpec>;
#[doc = "Register `P0CFG` writer"]
pub type W = crate::W<P0cfgSpec>;
...
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p0cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0cfgSpec;
impl crate::RegisterSpec for P0cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0cfg::R`](R) reader structure"]
impl crate::Readable for P0cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`p0cfg::W`](W) writer structure"]
impl crate::Writable for P0cfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P0CFG to value 0"]
impl crate::Resettable for P0cfgSpec {
