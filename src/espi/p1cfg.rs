#[doc = "Register `P1CFG` reader"]
pub type R = crate::R<P1cfgSpec>;
#[doc = "Register `P1CFG` writer"]
pub type W = crate::W<P1cfgSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn type_(&mut self) -> TypeW<P1cfgSpec> {
        TypeW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Meaning depends on Type, but generally picks the direction of the port (Host writes, Host reads, or both)"]
    #[inline(always)]
    #[must_use]
    pub fn direction(&mut self) -> DirectionW<P1cfgSpec> {
        DirectionW::new(self, 5)
    }
    #[doc = "Bit 7 - Mailbox: Map interrupt on Read 1st and Write 1st to every read/write (special will still control 0th and last location)"]
    #[inline(always)]
    #[must_use]
    pub fn mbint_all(&mut self) -> MbintAllW<P1cfgSpec> {
        MbintAllW::new(self, 7)
    }
    #[doc = "Bit 8 - Stall on any Read of Index/Data and Mailbox (only)"]
    #[inline(always)]
    #[must_use]
    pub fn stall_rd(&mut self) -> StallRdW<P1cfgSpec> {
        StallRdW::new(self, 8)
    }
    #[doc = "Bit 9 - Stall on any Write of Index/Data and Mailbox"]
    #[inline(always)]
    #[must_use]
    pub fn stall_wr(&mut self) -> StallWrW<P1cfgSpec> {
        StallWrW::new(self, 9)
    }
    #[doc = "Bit 10 - If 1, the Host will get an error when trying to perform a read or write that is blocked by the Direction field"]
    #[inline(always)]
    #[must_use]
    pub fn error_ign(&mut self) -> ErrorIgnW<P1cfgSpec> {
        ErrorIgnW::new(self, 10)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p1cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1cfgSpec;
impl crate::RegisterSpec for P1cfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1cfg::R`](R) reader structure"]
impl crate::Readable for P1cfgSpec {}
#[doc = "`write(|w| ..)` method takes [`p1cfg::W`](W) writer structure"]
impl crate::Writable for P1cfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P1CFG to value 0"]
impl crate::Resettable for P1cfgSpec {
