#[doc = "Register `P0DataIn` reader"]
pub type R = crate::R<P0dataInSpec>;
...
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p0data_in::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0dataInSpec;
impl crate::RegisterSpec for P0dataInSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0data_in::R`](R) reader structure"]
impl crate::Readable for P0dataInSpec {}
#[doc = "`reset()` method sets P0DataIn to value 0"]
impl crate::Resettable for P0dataInSpec {
