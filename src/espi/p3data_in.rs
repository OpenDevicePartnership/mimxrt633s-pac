#[doc = "Register `P3DataIn` reader"]
pub type R = crate::R<P3dataInSpec>;
...
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p3data_in::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P3dataInSpec;
impl crate::RegisterSpec for P3dataInSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p3data_in::R`](R) reader structure"]
impl crate::Readable for P3dataInSpec {}
#[doc = "`reset()` method sets P3DataIn to value 0"]
impl crate::Resettable for P3dataInSpec {
