#[doc = "Register `P1DataIn` reader"]
pub type R = crate::R<P1dataInSpec>;
...
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p1data_in::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1dataInSpec;
impl crate::RegisterSpec for P1dataInSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1data_in::R`](R) reader structure"]
impl crate::Readable for P1dataInSpec {}
#[doc = "`reset()` method sets P1DataIn to value 0"]
impl crate::Resettable for P1dataInSpec {
