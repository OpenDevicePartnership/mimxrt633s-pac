#[doc = "Register `P3IRuleStat` reader"]
pub type R = crate::R<P3iruleStatSpec>;
#[doc = "Register `P3IRuleStat` writer"]
pub type W = crate::W<P3iruleStatSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ustat(&mut self) -> UstatW<P3iruleStatSpec> {
        UstatW::new(self, 0)
    }
    #[doc = "Bit 8 - Interrupt if an error is detected (classes of error defined in section 2.14)"]
    #[inline(always)]
    #[must_use]
    pub fn interr(&mut self) -> InterrW<P3iruleStatSpec> {
        InterrW::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt if Read or 1st Read or Bus master Started."]
    #[inline(always)]
    #[must_use]
    pub fn intrd(&mut self) -> IntrdW<P3iruleStatSpec> {
        IntrdW::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt if Write or 1st Write or Bus master Finished."]
    #[inline(always)]
    #[must_use]
    pub fn intwr(&mut self) -> IntwrW<P3iruleStatSpec> {
        IntwrW::new(self, 10)
    }
    #[doc = "Bits 11:14 - Interrupt if: Bit Endpoint Idx/Data Mbox BusMaster/Flash SPC0 CMD Idx Change Write 0 Completed SPC1 - - Read 0 - SPC2 - - Write Last - SPC3 - - Read Last -"]
    #[inline(always)]
    #[must_use]
    pub fn intspc(&mut self) -> IntspcW<P3iruleStatSpec> {
        IntspcW::new(self, 11)
    }
    #[doc = "Bits 16:19 - Status set/clear"]
    #[inline(always)]
    #[must_use]
    pub fn sstcl(&mut self) -> SstclW<P3iruleStatSpec> {
        SstclW::new(self, 16)
    }
    #[doc = "Bit 20 - Resets the RdStatus and WrStatus in PStatus register"]
    #[inline(always)]
    #[must_use]
    pub fn srst(&mut self) -> SrstW<P3iruleStatSpec> {
        SrstW::new(self, 20)
    }
}
#[doc = "The Port Set Interrupt-Rule and Set User Status register is used to set: The interrupt causes per port. That is, it is used to select what events from the port should cause an interrupt, if any. The user Status bits. The status byte returned to the host will be composed of both these user bits (which the application defines) and automatically generated status. The interrupt masks then are matched by sticky cause bits in PnSTAT (which can be read and then write-1 cleared). The sticky bits are set whether the interrupt is masked or not, but the masks cause an interrupt when the bits are set and the port is int enabled via INTENSET.\n\nYou can [`read`](crate::Reg::read) this register and get [`p3irule_stat::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p3irule_stat::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P3iruleStatSpec;
impl crate::RegisterSpec for P3iruleStatSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p3irule_stat::R`](R) reader structure"]
impl crate::Readable for P3iruleStatSpec {}
#[doc = "`write(|w| ..)` method takes [`p3irule_stat::W`](W) writer structure"]
impl crate::Writable for P3iruleStatSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P3IRuleStat to value 0"]
impl crate::Resettable for P3iruleStatSpec {
