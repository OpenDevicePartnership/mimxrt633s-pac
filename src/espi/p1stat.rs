#[doc = "Register `P1STAT` reader"]
pub type R = crate::R<P1statSpec>;
#[doc = "Register `P1STAT` writer"]
pub type W = crate::W<P1statSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn interr(&mut self) -> InterrW<P1statSpec> {
        InterrW::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt was caused by Read or 1st Read or Bus master Started."]
    #[inline(always)]
    #[must_use]
    pub fn intrd(&mut self) -> IntrdW<P1statSpec> {
        IntrdW::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt was caused by Write or 1st Write or Bus master Started."]
    #[inline(always)]
    #[must_use]
    pub fn intwr(&mut self) -> IntwrW<P1statSpec> {
        IntwrW::new(self, 10)
    }
    #[doc = "Bits 11:14 - Interrupt was caused by: Bit Endpoint Idx/Data Mbox BusMaster/Flash SPC0 CMD Idx Change Write 0 Completed SPC1 - - Read 0 - SPC2 - - Write Last - SPC3 - - Read Last -"]
    #[inline(always)]
    #[must_use]
    pub fn intspc(&mut self) -> IntspcW<P1statSpec> {
        IntspcW::new(self, 11)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p1stat::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p1stat::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P1statSpec;
impl crate::RegisterSpec for P1statSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p1stat::R`](R) reader structure"]
impl crate::Readable for P1statSpec {}
#[doc = "`write(|w| ..)` method takes [`p1stat::W`](W) writer structure"]
impl crate::Writable for P1statSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P1STAT to value 0"]
impl crate::Resettable for P1statSpec {
