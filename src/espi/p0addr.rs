#[doc = "Register `P0ADDR` reader"]
pub type R = crate::R<P0addrSpec>;
#[doc = "Register `P0ADDR` writer"]
pub type W = crate::W<P0addrSpec>;
...
#[doc = "`read()` method returns [`p0addr::R`](R) reader structure"]
impl crate::Readable for P0addrSpec {}
#[doc = "`write(|w| ..)` method takes [`p0addr::W`](W) writer structure"]
impl crate::Writable for P0addrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P0ADDR to value 0"]
impl crate::Resettable for P0addrSpec {
