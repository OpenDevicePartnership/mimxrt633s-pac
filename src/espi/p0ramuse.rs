#[doc = "Register `P0RAMUse` reader"]
pub type R = crate::R<P0ramuseSpec>;
#[doc = "Register `P0RAMUse` writer"]
pub type W = crate::W<P0ramuseSpec>;
...
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p0ramuse::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p0ramuse::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P0ramuseSpec;
impl crate::RegisterSpec for P0ramuseSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p0ramuse::R`](R) reader structure"]
impl crate::Readable for P0ramuseSpec {}
#[doc = "`write(|w| ..)` method takes [`p0ramuse::W`](W) writer structure"]
impl crate::Writable for P0ramuseSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P0RAMUse to value 0"]
impl crate::Resettable for P0ramuseSpec {
