#[doc = "Register `P3STAT` reader"]
pub type R = crate::R<P3statSpec>;
#[doc = "Register `P3STAT` writer"]
pub type W = crate::W<P3statSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn interr(&mut self) -> InterrW<P3statSpec> {
        InterrW::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt was caused by Read or 1st Read or Bus master Started."]
    #[inline(always)]
    #[must_use]
    pub fn intrd(&mut self) -> IntrdW<P3statSpec> {
        IntrdW::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt was caused by Write or 1st Write or Bus master Started."]
    #[inline(always)]
    #[must_use]
    pub fn intwr(&mut self) -> IntwrW<P3statSpec> {
        IntwrW::new(self, 10)
    }
    #[doc = "Bits 11:14 - Interrupt was caused by: Bit Endpoint Idx/Data Mbox BusMaster/Flash SPC0 CMD Idx Change Write 0 Completed SPC1 - - Read 0 - SPC2 - - Write Last - SPC3 - - Read Last -"]
    #[inline(always)]
    #[must_use]
    pub fn intspc(&mut self) -> IntspcW<P3statSpec> {
        IntspcW::new(self, 11)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p3stat::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p3stat::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P3statSpec;
impl crate::RegisterSpec for P3statSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p3stat::R`](R) reader structure"]
impl crate::Readable for P3statSpec {}
#[doc = "`write(|w| ..)` method takes [`p3stat::W`](W) writer structure"]
impl crate::Writable for P3statSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P3STAT to value 0"]
impl crate::Resettable for P3statSpec {
