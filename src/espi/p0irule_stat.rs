#[doc = "Register `P0IRuleStat` reader"]
pub type R = crate::R<P0iruleStatSpec>;
#[doc = "Register `P0IRuleStat` writer"]
pub type W = crate::W<P0iruleStatSpec>;
