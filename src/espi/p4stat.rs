#[doc = "Register `P4STAT` reader"]
pub type R = crate::R<P4statSpec>;
#[doc = "Register `P4STAT` writer"]
pub type W = crate::W<P4statSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn interr(&mut self) -> InterrW<P4statSpec> {
        InterrW::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt was caused by Read or 1st Read or Bus master Started."]
    #[inline(always)]
    #[must_use]
    pub fn intrd(&mut self) -> IntrdW<P4statSpec> {
        IntrdW::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt was caused by Write or 1st Write or Bus master Started."]
    #[inline(always)]
    #[must_use]
    pub fn intwr(&mut self) -> IntwrW<P4statSpec> {
        IntwrW::new(self, 10)
    }
    #[doc = "Bits 11:14 - Interrupt was caused by: Bit Endpoint Idx/Data Mbox BusMaster/Flash SPC0 CMD Idx Change Write 0 Completed SPC1 - - Read 0 - SPC2 - - Write Last - SPC3 - - Read Last -"]
    #[inline(always)]
    #[must_use]
    pub fn intspc(&mut self) -> IntspcW<P4statSpec> {
        IntspcW::new(self, 11)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p4stat::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p4stat::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P4statSpec;
impl crate::RegisterSpec for P4statSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p4stat::R`](R) reader structure"]
impl crate::Readable for P4statSpec {}
#[doc = "`write(|w| ..)` method takes [`p4stat::W`](W) writer structure"]
impl crate::Writable for P4statSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P4STAT to value 0"]
impl crate::Resettable for P4statSpec {
