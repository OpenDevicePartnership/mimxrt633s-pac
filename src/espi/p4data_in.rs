#[doc = "Register `P4DataIn` reader"]
pub type R = crate::R<P4dataInSpec>;
...
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`p4data_in::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P4dataInSpec;
impl crate::RegisterSpec for P4dataInSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p4data_in::R`](R) reader structure"]
impl crate::Readable for P4dataInSpec {}
#[doc = "`reset()` method sets P4DataIn to value 0"]
impl crate::Resettable for P4dataInSpec {
