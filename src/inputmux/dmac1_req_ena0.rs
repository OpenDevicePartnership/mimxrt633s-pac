#[doc = "Register `DMAC1_REQ_ENA0` reader"]
pub type R = crate::R<Dmac1ReqEna0Spec>;
...
#[doc = "Field `ESPI_CH0` reader - ESPI Channel 0 enable"]
pub type EspiCh0R = crate::BitReader<EspiCh0>;
impl EspiCh0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> EspiCh0 {
        match self.bits {
            false => EspiCh0::Disabled,
            true => EspiCh0::Enabled,
        }
    }
    #[doc = "disable"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == EspiCh0::Disabled
    }
    #[doc = "enable"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == EspiCh0::Enabled
    }
}
#[doc = "Field `ESPI_CH0` writer - ESPI Channel 0 enable"]
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(EspiCh0::Disabled)
    }
    #[doc = "enable"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(EspiCh0::Enabled)
    }
}
impl R {
    ...
    #[doc = "Bit 31 - ESPI Channel 0 enable"]
    #[inline(always)]
    pub fn espi_ch0(&self) -> EspiCh0R {
        EspiCh0R::new(((self.bits >> 31) & 1) != 0)
    }
}
#[cfg(feature = "debug")]
...
impl W {
    #[doc = "Bit 0 - FLEXCOMM0 RX enable"]
    #[inline(always)]
    pub fn flexcomm0_rx(&mut self) -> Flexcomm0RxW<Dmac1ReqEna0Spec> {
        Flexcomm0RxW::new(self, 0)
    }
    #[doc = "Bit 1 - FLEXCOMM0 TX enable"]
    #[inline(always)]
    pub fn flexcomm0_tx(&mut self) -> Flexcomm0TxW<Dmac1ReqEna0Spec> {
        Flexcomm0TxW::new(self, 1)
    }
    #[doc = "Bit 2 - FLEXCOMM1 RX enable"]
    #[inline(always)]
    pub fn flexcomm1_rx(&mut self) -> Flexcomm1RxW<Dmac1ReqEna0Spec> {
        Flexcomm1RxW::new(self, 2)
    }
    #[doc = "Bit 3 - FLEXCOMM1 TX enable"]
    #[inline(always)]
    pub fn flexcomm1_tx(&mut self) -> Flexcomm1TxW<Dmac1ReqEna0Spec> {
        Flexcomm1TxW::new(self, 3)
    }
    #[doc = "Bit 4 - FLEXCOMM2 RX enable"]
    #[inline(always)]
    pub fn flexcomm2_rx(&mut self) -> Flexcomm2RxW<Dmac1ReqEna0Spec> {
        Flexcomm2RxW::new(self, 4)
    }
    #[doc = "Bit 5 - FLEXCOMM2 TX enable"]
    #[inline(always)]
    pub fn flexcomm2_tx(&mut self) -> Flexcomm2TxW<Dmac1ReqEna0Spec> {
        Flexcomm2TxW::new(self, 5)
    }
    #[doc = "Bit 6 - FLEXCOMM3 RX enable"]
    #[inline(always)]
    pub fn flexcomm3_rx(&mut self) -> Flexcomm3RxW<Dmac1ReqEna0Spec> {
        Flexcomm3RxW::new(self, 6)
    }
    #[doc = "Bit 7 - FLEXCOMM3 TX enable"]
    #[inline(always)]
    pub fn flexcomm3_tx(&mut self) -> Flexcomm3TxW<Dmac1ReqEna0Spec> {
        Flexcomm3TxW::new(self, 7)
    }
    #[doc = "Bit 8 - FLEXCOMM4 RX enable"]
    #[inline(always)]
    pub fn flexcomm4_rx(&mut self) -> Flexcomm4RxW<Dmac1ReqEna0Spec> {
        Flexcomm4RxW::new(self, 8)
    }
    #[doc = "Bit 9 - FLEXCOMM4 TX enable"]
    #[inline(always)]
    pub fn flexcomm4_tx(&mut self) -> Flexcomm4TxW<Dmac1ReqEna0Spec> {
        Flexcomm4TxW::new(self, 9)
    }
    #[doc = "Bit 10 - FLEXCOMM5 RX enable"]
    #[inline(always)]
    pub fn flexcomm5_rx(&mut self) -> Flexcomm5RxW<Dmac1ReqEna0Spec> {
        Flexcomm5RxW::new(self, 10)
    }
    #[doc = "Bit 11 - FLEXCOMM5 TX enable"]
    #[inline(always)]
    pub fn flexcomm5_tx(&mut self) -> Flexcomm5TxW<Dmac1ReqEna0Spec> {
        Flexcomm5TxW::new(self, 11)
    }
    #[doc = "Bit 12 - FLEXCOMM6 RX enable"]
    #[inline(always)]
    pub fn flexcomm6_rx(&mut self) -> Flexcomm6RxW<Dmac1ReqEna0Spec> {
        Flexcomm6RxW::new(self, 12)
    }
    #[doc = "Bit 13 - FLEXCOMM6 TX enable"]
    #[inline(always)]
    pub fn flexcomm6_tx(&mut self) -> Flexcomm6TxW<Dmac1ReqEna0Spec> {
        Flexcomm6TxW::new(self, 13)
    }
    #[doc = "Bit 14 - FLEXCOMM7 RX enable"]
    #[inline(always)]
    pub fn flexcomm7_rx(&mut self) -> Flexcomm7RxW<Dmac1ReqEna0Spec> {
        Flexcomm7RxW::new(self, 14)
    }
    #[doc = "Bit 15 - FLEXCOMM7 TX enable"]
    #[inline(always)]
    pub fn flexcomm7_tx(&mut self) -> Flexcomm7TxW<Dmac1ReqEna0Spec> {
        Flexcomm7TxW::new(self, 15)
    }
    #[doc = "Bit 16 - DMIC0 channel 0 enable"]
    #[inline(always)]
    pub fn dmic0ch0(&mut self) -> Dmic0ch0W<Dmac1ReqEna0Spec> {
        Dmic0ch0W::new(self, 16)
    }
    #[doc = "Bit 17 - DMIC0 channel 1 enable"]
    #[inline(always)]
    pub fn dmic0ch1(&mut self) -> Dmic0ch1W<Dmac1ReqEna0Spec> {
        Dmic0ch1W::new(self, 17)
    }
    #[doc = "Bit 18 - DMIC0 channel 2 enable"]
    #[inline(always)]
    pub fn dmic0ch2(&mut self) -> Dmic0ch2W<Dmac1ReqEna0Spec> {
        Dmic0ch2W::new(self, 18)
    }
    #[doc = "Bit 19 - DMIC0 channel 3 enable"]
    #[inline(always)]
    pub fn dmic0ch3(&mut self) -> Dmic0ch3W<Dmac1ReqEna0Spec> {
        Dmic0ch3W::new(self, 19)
    }
    #[doc = "Bit 20 - DMIC0 channel 4 enable"]
    #[inline(always)]
    pub fn dmic0ch4(&mut self) -> Dmic0ch4W<Dmac1ReqEna0Spec> {
        Dmic0ch4W::new(self, 20)
    }
    #[doc = "Bit 21 - DMIC0 channel 5 enable"]
    #[inline(always)]
    pub fn dmic0ch5(&mut self) -> Dmic0ch5W<Dmac1ReqEna0Spec> {
        Dmic0ch5W::new(self, 21)
    }
    #[doc = "Bit 22 - DMIC0 channel 6 enable"]
    #[inline(always)]
    pub fn dmic0ch6(&mut self) -> Dmic0ch6W<Dmac1ReqEna0Spec> {
        Dmic0ch6W::new(self, 22)
    }
    #[doc = "Bit 23 - DMIC0 channel 7 enable"]
    #[inline(always)]
    pub fn dmic0ch7(&mut self) -> Dmic0ch7W<Dmac1ReqEna0Spec> {
        Dmic0ch7W::new(self, 23)
    }
    #[doc = "Bit 24 - I3C RX enable"]
    #[inline(always)]
    pub fn i3c0_rx(&mut self) -> I3c0RxW<Dmac1ReqEna0Spec> {
        I3c0RxW::new(self, 24)
    }
    #[doc = "Bit 25 - I3C TX enable"]
    #[inline(always)]
    pub fn i3c0_tx(&mut self) -> I3c0TxW<Dmac1ReqEna0Spec> {
        I3c0TxW::new(self, 25)
    }
    #[doc = "Bit 26 - FLEXCOMM14 RX enable"]
    #[inline(always)]
    pub fn flexcomm14_rx(&mut self) -> Flexcomm14RxW<Dmac1ReqEna0Spec> {
        Flexcomm14RxW::new(self, 26)
    }
    #[doc = "Bit 27 - FLEXCOMM14 TX enable"]
    #[inline(always)]
    pub fn flexcomm14_tx(&mut self) -> Flexcomm14TxW<Dmac1ReqEna0Spec> {
        Flexcomm14TxW::new(self, 27)
    }
    #[doc = "Bit 30 - hash enable"]
    #[inline(always)]
    pub fn hashcrypt(&mut self) -> HashcryptW<Dmac1ReqEna0Spec> {
        HashcryptW::new(self, 30)
    }
    #[doc = "Bit 31 - ESPI Channel 0 enable"]
    #[inline(always)]
    pub fn espi_ch0(&mut self) -> EspiCh0W<Dmac1ReqEna0Spec> {
        EspiCh0W::new(self, 31)
    }
}
#[doc = "DMAC1 request enable 0\n\nYou can [`read`](crate::Reg::read) this register and get [`dmac1_req_ena0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmac1_req_ena0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Dmac1ReqEna0Spec;
impl crate::RegisterSpec for Dmac1ReqEna0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmac1_req_ena0::R`](R) reader structure"]
impl crate::Readable for Dmac1ReqEna0Spec {}
#[doc = "`write(|w| ..)` method takes [`dmac1_req_ena0::W`](W) writer structure"]
impl crate::Writable for Dmac1ReqEna0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMAC1_REQ_ENA0 to value 0xffff_ffff"]
impl crate::Resettable for Dmac1ReqEna0Spec {
